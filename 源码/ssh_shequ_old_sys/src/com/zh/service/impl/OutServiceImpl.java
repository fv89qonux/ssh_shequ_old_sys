...
public class OutServiceImpl implements OutService{
	...
	public List<Map<String, Object>> get(Map<String, Object> map) {
		String sql="SELECT i.*,u.name FROM outLog i LEFT JOIN user u ON i.userId=u.id";
	...
	public Integer add(Out out) {
		/*String hql = "INSERT INTO out (create_time, userId, withName) VALUES ("+out.getCreate_time()+","+out.getUserId()+","+out.getWithName()+")";
		dao.executeSql(hql);*/
		dao.save(out);
		return 0;
	}
